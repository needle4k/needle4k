...
import io.github.needle4k.injection.*
import io.github.needle4k.mock.SpyProvider
import io.github.needle4k.reflection.ReflectionUtil
import io.github.needle4k.reflection.getAllFieldsWithSupportedAnnotation
import org.slf4j.LoggerFactory
import java.lang.reflect.*

/**
 * Abstract test case to process and initialize all fields annotated with
 * [ObjectUnderTest]. After initialization, [io.github.needle4k.annotation.InjectIntoMany] and
 ...
 * @see InjectInto
 *
 * @see io.github.needle4k.annotation.InjectIntoMany
 *
 * @see io.github.needle4k.injection.InjectionProvider
 *
 *
...
class NeedleInjector constructor(
   ...
   * [io.github.needle4k.annotation.InjectIntoMany] and [InjectInto] annotations are processed
